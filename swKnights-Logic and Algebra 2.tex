...
\include{settings/usefullMacros}

\include{contents/0-intro/introduction}

\include{contents/1-sintassi/primo1}

\include{contents/2-assiomi/assiomi}

\include{contents/3-determinata/det1}

\include{contents/4-determinata/det2}\include{contents/5-decidibile/dec}

\include{contents/6-temporale/temporale}

\include{contents/7-multimodale/multimodale}

\include{\string"contents/8-classica multimodale/class-multi\string"}

\include{contents/9-descrittiva/descrittiva}

\include{contents/10-ModalePrimOrdine/modaleprimo}

\include{contents/11-Bisimulazione/bisimulazione}

\include{contents/12-ModelCheking/modelcheck}
\end{document}
